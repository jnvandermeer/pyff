...
class PsychopyFeedback(MainloopFeedback):
    ...
    def init_psychopy(self):
        ...
        win1 = visual.Window(SCREEN_SIZE, monitor='Monitor_01', screen=1, fullscr=False, allowGUI=False)
        win2 = visual.Window(SCREEN_SIZE, monitor='Monitor_02', screen=2, fullscr=False, allowGUI=False)
